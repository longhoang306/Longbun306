            ...
            <table class="table table-bordered">
                ...
                @foreach ($data as $r)
                    <tr>
                        ...
                        <td>{{$r->sell_count}}</td>
                        <td>
                            <a href="{{url('admin/products/delete?id='.$r->id)}}"><i class="fa fa-trash"> Xoá </i></a><br><br>
                            <a href="{{url('admin/products/edit?id='.$r->id)}}"><i class="fa fa-pencil-square-o"> Sửa </i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
