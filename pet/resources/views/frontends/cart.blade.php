            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="table-responsive cart-calculations">
                    <table class="table">
                        ...
                        <thead class="cart_table_heading" style="background-image: linear-gradient(to right, #ff1464, purple);">
                        <tr>
                            <th>item</th>
                        ...
                        <form class="custom-form" method="post" action="{{url('checkout')}}">
                            ...
                            <div>
                                <input type="submit" value="checkout"
                                       style="padding:10px;background-image: linear-gradient(to right, #ff1464, purple);color:white;border:0px;border-radius:5px"/>
                            </div>
