                    ...
                    <form method="GET" action="{{url('search')}}">
                        <ul>
                            ...
                            <li class="shop_btn_wrapper">
                                <ul>
                                    <li>
                                        <button style="padding:10px;background-image: linear-gradient(to right, #ff1464, purple);color:white;border:0px;border-radius:10px;width:70px">
                                            Filter
                                        </button>
                                    </li>
                                </ul>
                                                ...
                                                <div class="btc_shop_indx_img_wrapper">
                                                    ...
                                                    @if ($r->images!=null && count($r->images)>0)
                                                        ...
                                                        <img src="{{asset('storage/'.$r->images[0]->path)}}"
                                                             alt="shop_img"
                                                             class="img-responsive" style="width:400px;height:350px">
                                                    @else
