...
class CategoryController extends Controller
{
    function index(){
        ...
        return view('admin.category.index',['data'=>$data, 'filter_type'=>$filterType]);
    }
    //
    function add(Request $request)
    {
        ...
        $data = Category::all();
        $filterType = FilterType::all();
        return view('admin.category.add',['parentCategory'=>$data,'filter_type'=>$filterType]);
    }
    ...
    function edit(Request $request){
        ...
        return view('admin.category.edit',['category'=>$category,'parentCategory'=>$data,'filter_type'=>$filterType]);
    }
