...
//Route::post('', 'UserorderController@userorder')->middleware(['auth']);
Route::get('/user/order', 'UserController@order');
Route::get('/user/orderdetail/{id}', 'UserController@orderdetail');
...
Route::prefix('admin')->middleware(['check-user-level'])->group(function () {
    ...
    Route::prefix('orders')->group(function(){
        Route::get('/edit','Admin\OrderController@edit');
        Route::post('/edit','Admin\OrderController@edit');
        Route::get('/','Admin\OrderController@index');
        Route::get('/delete','Admin\OrderController@delete');
    });

    // Route::prefix('userorder')->group(function(){
    //     Route::get('/edit','Admin\userorderController@edit');
    //     Route::post('/edit','Admin\userorderController@edit');
    //     Route::get('/','Admin\UserorderController@index');
    //     Route::get('/delete','Admin\userorderController@delete');
    // });
